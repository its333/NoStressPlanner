          ...
          <div className="p-4 space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${getScoreColor(performanceData.performanceScore)}`}>
            ...
            {/* Web Vitals */}
            <div>
              <h4 className="text-sm font-medium text-gray-900 mb-2">Web Vitals</h4>
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="flex justify-between">
                  <span className="text-gray-600">CLS:</span>
                  <span className="font-mono">{formatMetric(performanceData.webVitals.CLS)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">FID:</span>
                  <span className="font-mono">{formatMetric(performanceData.webVitals.FID)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">FCP:</span>
                  <span className="font-mono">{formatMetric(performanceData.webVitals.FCP)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">LCP:</span>
                  <span className="font-mono">{formatMetric(performanceData.webVitals.LCP)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">TTFB:</span>
                  <span className="font-mono">{formatMetric(performanceData.webVitals.TTFB)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">INP:</span>
                  <span className="font-mono">{formatMetric(performanceData.webVitals.INP)}</span>
                </div>
              </div>
            </div>
            ...
            {/* Network Status */}
            <div>
              <h4 className="text-sm font-medium text-gray-900 mb-2">Network Status</h4>
              <div className="space-y-1 text-xs">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    ...
                    {performanceData.networkStatus.isOnline ? 'Online' : 'Offline'}
                  </span>
                </div>
                {performanceData.networkStatus.connectionType && (
                  <div className="flex justify-between">
                    <span className="text-gray-600">Connection:</span>
                    <span className="font-mono">{performanceData.networkStatus.connectionType}</span>
                  </div>
                )}
            ...
            {performanceData.offlineQueue.size > 0 && (
              <div>
                <h4 className="text-sm font-medium text-gray-900 mb-2">Offline Queue</h4>
